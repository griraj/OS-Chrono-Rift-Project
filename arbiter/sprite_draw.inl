/* ─────────────────────────────────────────────────────────────────
 * sprite_draw.inl  — pixel-art sprite helpers for arbiter.cpp
 * Include this file once, right after #include "inventory.h"
 * ─────────────────────────────────────────────────────────────────
 * Each sprite drawn on 10-col x 10-row grid, 2x2 px per cell
 * => 20x20 screen pixels total.
 */
